...
// import 'package:lane_dane/repository/category_repo/category_local.dart';
...
//     final suggestions = categoryModel.where((CategoriesModel element) {
//       return element.message.isCaseInsensitiveContains(query);
//     }).toList();

//     if (!suggestions.any((CategoriesModel c) {
//           return c.message == query;
//         }) &&
//         query.isNotEmpty) {
//       CategoriesModel category =
//           CategoriesModel(message: query, lastAccessed: DateTime.now());
//       suggestions.insert(0, category);
//     }

//     // log.i('Suggestions ${suggestions.length}');
...
//       itemBuilder: ((context, index) {
//         var result = suggestions.elementAt(index);
//         return ListTile(
